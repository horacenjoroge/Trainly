...
data class PostDto(@SerializedName("_id") val id: String?=null, val userId: UserDto?=null, val content: String?=null, val image: String?=null, val likes: List<String>?=null, val comments: List<CommentDto>?=null, val createdAt: String?=null, val privacy: String?=null)
