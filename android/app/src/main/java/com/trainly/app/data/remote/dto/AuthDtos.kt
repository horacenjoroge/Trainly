...
data class UserDto(@SerializedName("_id") val id: String?, val name: String?, val email: String?, val avatar: String?, val bio: String?, val location: String?, val stats: UserStatsDto?)
