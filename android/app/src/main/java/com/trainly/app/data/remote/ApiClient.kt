...
@Singleton
class ApiClient @Inject constructor(private val ai: AuthInterceptor) {
    ...
    private val client = OkHttpClient.Builder().addInterceptor(ai).addInterceptor(logging).connectTimeout(30, TimeUnit.SECONDS).readTimeout(30, TimeUnit.SECONDS).writeTimeout(30, TimeUnit.SECONDS).build()
